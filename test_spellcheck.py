...
def test_length(input_value):
    ...
    assert spellcheck.word_count(input_value) < 10 and spellcheck.char_count(input_value) < 50
    return
...
def test_struc(input_value):
    ...
    """
    ### WRITE SOLUTION CODE HERE
    assert spellcheck.first_char(input_value).isupper() and spellcheck.last_char(input_value)=="."
    return
    raise NotImplementedError()
